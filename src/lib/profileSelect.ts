...
const PROFILE_COLUMNS_CORE =
  "id, first_name, birth_date, gender, looking_for, intent, portrait_url, fullbody_url, main_photo_url, profile_completed, is_photo_verified, photo_status, needs_adapted_activities, city, latitude, longitude, discovery_radius_km, location_updated_at, photo1_status, photo2_status, photo_moderation_overall, is_under_review, moderation_strikes_count";
