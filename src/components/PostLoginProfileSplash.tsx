...
/**
 * Plein écran post-connexion : fond sombre SPLove, logo centré, cœur en orbite légère,
 * suggestion très discrète de carte Discover en arrière-plan (sans logique métier).
 */
export function PostLoginProfileSplash() {
  return (
    <div
      ...
      <div className="relative z-[1] flex flex-col items-center">
        <div className="relative flex h-[200px] w-[200px] items-center justify-center">
          ...
          <div
            ...
            style={{
              animation: "splovePostLoginOrbit 5.5s linear infinite",
            }}
            aria-hidden
          >
            <span
