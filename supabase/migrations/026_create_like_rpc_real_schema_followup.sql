-- Fix follow-up si la migration 025 initiale référençait matches.conversation_id (colonne absente).
-- Idempotent : remplace la fonction par la version alignée sur le schéma réel (conversations.match_id).
